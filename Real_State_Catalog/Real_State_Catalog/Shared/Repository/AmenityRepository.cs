...
namespace Real_State_Catalog.Shared.Repository
{
    public class AmenityRepository : IAmenityRepository
    {
        ...
        public async Task<AmenityDTO> CreateAmenity(AmenityDTO hotelAmenity)
        {
            var amenity = _mapper.Map<AmenityDTO, Amenity>(hotelAmenity);
            amenity.CreatedBy = "";
            amenity.CreatedDate = DateTime.UtcNow;
            var addedHotelAmenity = await _context.Amenities.AddAsync(amenity);
            await _context.SaveChangesAsync();
            return _mapper.Map<Amenity, AmenityDTO>(addedHotelAmenity.Entity);
        }

        public async Task<AmenityDTO> UpdateAmenity(int amenityId, AmenityDTO hotelAmenity)
        {
